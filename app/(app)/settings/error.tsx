...
export default function SettingsError({
  ...
  useEffect(() => {
    console.error('[settings/error.tsx]', error);
  }, [error]);

  return (
    <div className="mx-auto max-w-3xl space-y-4 p-6">
      <h1 className="text-2xl font-semibold text-red-700">Settings konnte nicht geladen werden</h1>
      <p className="text-sm text-gray-600">
        Die Seite hat eine Exception geworfen. Hier sind die Details:
      </p>
